...
var OfferFormView = /** @class */ (function () {
    function OfferFormView(app, difficulties, abilities, runnerID) {
        ...
        this.element.appendChild(this.htmlConverter.element(templateObject_1 || (templateObject_1 = __makeTemplateObject(["<h1>", "</h1>"], ["<h1>", "</h1>"])), { Japanese: "リンク" }));
        ...
        this.simpleMDE = new simplemde_1.default({
            element: this.element.appendChild(this.htmlConverter.element(templateObject_2 || (templateObject_2 = __makeTemplateObject(["\n                                <div class=\"offerForm__noteInput\">\n                                    <h1><>", "</h1>\n                                    <ul class=\"u-margin05em\">\n                                        <li>", "</li>\n                                        <li>", "</li>\n                                        <li>", "</li>\n                                    </ul>\n                                </div>\n                                "], ["\n                                <div class=\"offerForm__noteInput\">\n                                    <h1><>", "</h1>\n                                    <ul class=\"u-margin05em\">\n                                        <li>", "</li>\n                                        <li>", "</li>\n                                        <li>", "</li>\n                                    </ul>\n                                </div>\n                                "])), { Japanese: "走者ノート" }, { Japanese: "[任意] 記録を出すうえで必要となる事項を書きます。" }, { Japanese: "markdownでの記述が出来ます。" }, { Japanese: "10秒に一度オートセーブを行います。" })).appendChild(aboutElement_1.createElementWithIdTagClass({ className: "offerForm__runnerNote" }, "textarea")),
            autosave: {
        ...
        this.element.appendChild(this.htmlConverter.element(templateObject_4 || (templateObject_4 = __makeTemplateObject(["<div class=\"u-width50per u-margin2em\"><div class=\"c-button\">\u6C7A\u5B9A</div></div>"], ["<div class=\"u-width50per u-margin2em\"><div class=\"c-button\">\u6C7A\u5B9A</div></div>"]))))
    ...
    OfferFormView.prototype.createDifficultyChoices = function (difficulties) {
        var difficultySelector = this.element.appendChild(this.htmlConverter.element(templateObject_6 || (templateObject_6 = __makeTemplateObject(["\n        <div class=\"offerForm__difficultySelector\">\n            <h1>\u96E3\u6613\u5EA6</h1>\n            <div class=\"offerForm__difficultySelector__Choices\">\n            </div>\n            <ul class=\"u-margin05em\">\n                <li>", "</li>\n            </ul>\n        </div>"], ["\n        <div class=\"offerForm__difficultySelector\">\n            <h1>\u96E3\u6613\u5EA6</h1>\n            <div class=\"offerForm__difficultySelector__Choices\">\n            </div>\n            <ul class=\"u-margin05em\">\n                <li>", "</li>\n            </ul>\n        </div>"])), { Japanese: "<strong class='u-redChara'>[必須]</strong> 取得した記録がどの難易度で取られたかを入力します。" }));
    ...
    OfferFormView.prototype.createTargetChoices = function (targets) {
        var targetSelector = this.element.appendChild(this.htmlConverter.element(templateObject_7 || (templateObject_7 = __makeTemplateObject(["\n        <div class=\"offerForm__targetSelector\">\n            <h1>\u8A08\u6E2C\u5BFE\u8C61</h1>\n            <div class=\"offerForm__targetSelector__Choices\">\n            </div>\n            <ul class=\"u-margin05em\">\n                <li>", "</li>\n            </ul>\n        </div>"], ["\n        <div class=\"offerForm__targetSelector\">\n            <h1>\u8A08\u6E2C\u5BFE\u8C61</h1>\n            <div class=\"offerForm__targetSelector__Choices\">\n            </div>\n            <ul class=\"u-margin05em\">\n                <li>", "</li>\n            </ul>\n        </div>"])), { Japanese: "<strong class='u-redChara'>[必須]</strong> どの敵を倒したか / どのステージをクリアしたかを入力します。" }));
    ...
    OfferFormView.prototype.createAbilityChoices = function (abilities) {
        ...
        var abilitySelector = this.element.appendChild(this.htmlConverter.element(templateObject_8 || (templateObject_8 = __makeTemplateObject(["\n        <div class=\"offerForm__abilitySelector\">\n            <h1>\u81EA\u6A5F\u306E\u80FD\u529B</h1>\n            <div class=\"offerForm__abilitySelector__Choices\">\n            </div>\n            <ul class=\"u-margin05em\">\n                    <li>", "</li>\n                    <li>", "</li>\n                    <li>", "</li>\n            </ul>\n        </div>"], ["\n        <div class=\"offerForm__abilitySelector\">\n            <h1>\u81EA\u6A5F\u306E\u80FD\u529B</h1>\n            <div class=\"offerForm__abilitySelector__Choices\">\n            </div>\n            <ul class=\"u-margin05em\">\n                    <li>", "</li>\n                    <li>", "</li>\n                    <li>", "</li>\n            </ul>\n        </div>"])), { Japanese: "<strong class='u-redChara'>[必須]</strong> この記録を取った時のカービィのコピー能力を選びます。" }, { Japanese: "<strong>順序が考慮される</strong>ので注意してください。" }, { Japanese: "\u3053\u306E\u30B2\u30FC\u30E0\u30E2\u30FC\u30C9\u306F" + maxNumberOfPlayer + "\u4EBA\u30D7\u30EC\u30A4\u307E\u3067\u5BFE\u5FDC\u3057\u3066\u3044\u307E\u3059\u3002" }));
    ...
    OfferFormView.prototype.createTagInputChoices = function () {
        var tagSegment = this.element.appendChild(this.htmlConverter.element(templateObject_9 || (templateObject_9 = __makeTemplateObject(["\n        <div class=\"offerForm__tagInput\">\n        <h1>\u30BF\u30B0</h1>\n            <div class=\"offerForm__tagInput__Choices\">\n            </div>\n            <ul class=\"u-margin05em\">\n                    <li>", "</li>\n                    <li>", "</li>\n            </ul>\n        </div>"], ["\n        <div class=\"offerForm__tagInput\">\n        <h1>\u30BF\u30B0</h1>\n            <div class=\"offerForm__tagInput__Choices\">\n            </div>\n            <ul class=\"u-margin05em\">\n                    <li>", "</li>\n                    <li>", "</li>\n            </ul>\n        </div>"])), { Japanese: "[任意] 使ったTAにおけるテクニックの名前などをタグとして登録します。" }, { Japanese: "検索がより容易になります。" }));
