...
var GameModeCardsGroup = /** @class */ (function () {
    function GameModeCardsGroup(gameSystemInfo, info, app) {
        ...
        this.app = app;
        this.element.appendChild(ViewUtility_1.elementWithoutEscaping(templateObject_1 || (templateObject_1 = __makeTemplateObject(["\n                <div id=\"articleTitle\">\n                    <div class=\"c-title\">\n                            <div class=\"c-title__main\"> ", " ", "</div>\n                            <div class=\"c-title__sub\">select the item of game mode where records you're looking for was set.</div>\n                    </div>\n                    <hr noshade class=\"u-bold\">\n                </div>\n        "], ["\n                <div id=\"articleTitle\">\n                    <div class=\"c-title\">\n                            <div class=\"c-title__main\"> ", " ", "</div>\n                            <div class=\"c-title__sub\">select the item of game mode where records you're looking for was set.</div>\n                    </div>\n                    <hr noshade class=\"u-bold\">\n                </div>\n        "])), aboutElement_1.generateIcooonHTML(gameSystemInfo), aboutLang_1.selectAppropriateName(gameSystemInfo, this.app.state.language)));
        try {
