...
async function modifyList_UseId<T extends ILabelledDocument>(
...
async function modifyList_UseSIdId<T extends ILabelledDocument>(
...
async function modifyList_UseSIdMIdId<T extends ILabelledDocument>(
