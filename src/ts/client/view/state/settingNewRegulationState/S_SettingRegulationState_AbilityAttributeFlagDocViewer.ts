...
import { IAbilityAttributeFlagItem } from "../../../../type/list/IAbilityAttributeItemWithoutCollections";
...
export class S_SettingRegulationState_AbilityAttributeFlagDocViewer
