import { isIReceivedDataAtServer_getlist_UseId } from "../../type/transmission/list/atServer_getlist/IReceivedDataAtServer_getlist_UseId.validator";
import { isIReceivedDataAtServer_getlist_UseSIdId } from "../../type/transmission/list/atServer_getlist/IReceivedDataAtServer_getlist_UseSIdId.validator";
import { isIReceivedDataAtServer_getlist_UseSIdMIdId } from "../../type/transmission/list/atServer_getlist/IReceivedDataAtServer_getlist_UseSIdMIdId.validator";
import { isIReceivedDataAtServer_pickUp_UseId } from "../../type/transmission/list/atServer_pickup/IReceivedDataAtServer_pickUp_UseId.validator";
import { isIReceivedDataAtServer_pickUp_UseSIdMIdId } from "../../type/transmission/list/atServer_pickup/IReceivedDataAtServer_pickUp_UseSIdMIdId.validator";
import { IReceivedData_listAbilities,IReceivedData_listDifficulties,  IReceivedData_listGameModes, IReceivedData_listGameSystems, IReceivedData_listHashTags, IReceivedData_listRunners, IReceivedData_listTargets, IReceivedData_pickUpAbility, IReceivedData_pickUpDifficulty, IReceivedData_pickUpGameSystem, IReceivedData_pickUpRunner, IReceivedData_pickUpTarget } from "../../type/transmission/list/relation";
import { isIReceivedDataAtServer_recordDetail } from "../../type/transmission/record/IReceivedDataAtServer_recordDetail.validator";
import { isIReceivedDataAtServer_recordSearch } from "../../type/transmission/record/IReceivedDataAtServer_recordSearch.validator";
import { IReceivedData_recordDetail, IReceivedData_recordSearch } from "../../type/transmission/record/relation";
import { IReceivedData } from "../../type/transmission/transmissionBase";
import { ValidateFunction } from '../../type/transmission/ValidateFunction';
...
import { ability, difficulty, gameSystem, runner, target } from "./list/pickUp";
